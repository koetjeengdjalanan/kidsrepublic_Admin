...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class='col'>
                <img src="<?= base_url("/assets/images/logo_sd.png") ?>" width="100%" class="rounded" alt="Logo_KidsRepublic">
            </div>
            <div class='col'>
                <div class="row">
                    Kids Republic<br />
            ...
            <div class='col' style="text-align: right;">
                <div class="row">
                    <div class="col">
                        <h5 style="font-weight: 800;">Invoice</h5>
                        <p>INV0001</p>
                    </div>
                    <div class="col">
                        <h5 style="font-weight: 800;">Due</h5>
            ...
            <div class='col' style="text-align: right;">
                <div class="row">
                    ...
                    <div class="col">
                        <h5 style="font-weight: 800;">Balance Due</h5>
                        <p><?= $balance_due_txt ?></p>
                    </div>
                </div>
            </div>
