                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $time ?></td>
                            <td><?= $token ?></td>
                            <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal_<?= $s_id ?>">Billed</button></td>
                            <!-- <td>
                                    <?= $s['status'];
                                    ?>
                                </td> -->
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header border-0 text-center">
                                        <h5 class="modal-title" id="exampleModalLabel">Invoice <?= $s_email ?></h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="text-center">
                                            <img src="<?= "http://101.255.120.81:21280/public/assets/upload/invoice/$invoice" ?>" width="50%" class="rounded" alt="...">
                                        </div>
                                    </div>
                                    <div class="modal-footer border-0">
                                        <a href="<?= base_url("finance/accept/$s_id") ?>" class="btn btn-success"><i class="glyphicon glyphicon-ok"></i></a>
                                        <a href="<?= base_url("finance/denied/$s_id") ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
